...
public class Deck {
   ...
   private final PlayingCardImpl[] gCards = new PlayingCardImpl[NUM_CARDS];
   ...
   public Deck() {
      ...
      for (int i = 0; i < NUM_CARDS; i++) {
         this.gCards[i] = new PlayingCardImpl(i);
      }
   }
   ...
   public void shuffle() {
      for (int i = 0; i < NUM_CARDS; i++) {
         ...
         PlayingCardImpl tempCard = this.gCards[j];
    ...
    *
    * @return PlayingCard on top of the deck
    */
   public PlayingCardImpl dealCard() {
    ...
    */
   public LinkedList<PlayingCard> asLinkedList() {
