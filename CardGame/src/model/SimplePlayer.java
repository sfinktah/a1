...
public class SimplePlayer implements Player {
   ...
   public SimplePlayer(@NotNull String playerId, @NotNull String playerName, int initialPoints) {
   ...
   public int compareTo(Player player) {
      ...
      int a = stringAsInt(this.getPlayerId(), -1);
      int b = stringAsInt(player.getPlayerId(), -1);
   ...
   public String toString() {
      return String.format("Player: id=\"%s\", name=\"%s\", bet=%d, points=%d, RESULT .. %d", getPlayerId(), getPlayerName(), getBet(), getPoints(), getResult());
   }
