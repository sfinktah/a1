...
Layout of source code:
    ...
    └── viewmodel
        ...
        └── PersonWrapper.java          * A wrapped (using composition) enhanced yet backwards compatible
                                          and interface compliant Person class. Persons are aware of their
                                          own index (in lists and tables) and adjust their index via
                                          subscription to PersonList's Observables
