...
public class MenuItemListener implements ActionListener {
   ...
   public MenuItemListener(BlackEngineImplEx model, AppView appView) {
      this.model = model;
   ...
   public static String simpleSerializeGameState(BlackEngineImplEx model) {
      String encoded = "";
      try {
         try (ByteArrayOutputStream fileOut = new ByteArrayOutputStream()) {
            try (ObjectOutputStream out = new ObjectOutputStream(fileOut)) {
               out.writeObject(model.getPersonList());
            }
   ...
   public void actionPerformed(ActionEvent e) {
      switch (e.getActionCommand()) {
         ...
         case "Copy":
            ...
            appView.setStatus("Copied 'PersonState' to clipboard");
            break;
