...
public class SummaryTable extends JTable {
   ...
   public SummaryTable(BlackEngineImplEx gameEngineImplEx) {
      super();
   ...
   public static class CustomCellRenderer extends DefaultTableCellRenderer {
      ...
      public CustomCellRenderer(BlackEngineImplEx gameEngineImplEx) {
      ...
      public Component getTableCellRendererComponent(JTable table,
         ...
         PersonWrapper player = gameEngineImplEx.getPersonList().at(row);
